 ...
 *
 * <p>
 * {@code rootCauses} may contain more than one service: a trace can have
 ...
 * i.e. cascade victims.
 */
public record RcaResultDTO(List<String> rootCauses, List<String> affectedServices, String reason,
