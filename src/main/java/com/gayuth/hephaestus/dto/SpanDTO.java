 ...
 * external dependency. JSON mapping lives in
 * {@code com.trace.ingest.TraceParser}.
 *
 * <p>
 * Times are in milliseconds. {@code parentSpanId} is {@code null} for the
 * root span.
 */
public record SpanDTO(String spanId, String parentSpanId, String serviceName, long startTime, long duration,
        SpanStatus status, Map<String, Object> attributes) {
    public SpanDTO {
